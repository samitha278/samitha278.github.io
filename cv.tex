...
\end{itemize}
{\small\color{muted}Research supported through the SMART Mens, Manus, and Machina (M3S) programme. Supervised by Prof. Archan Misra, with close guidance from Dr. Dulanga Weerakoon.}
...
\begin{tabularx}{\textwidth}{@{}>{\small\bfseries\color{ink}}p{0.19\textwidth} >{\small\color{muted}}X@{}}
